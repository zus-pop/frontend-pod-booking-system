...
const Logo = ({ isDark }) => (
  <div className="flex items-center">
    ...
    <div className="ml-2">
      ...
      <div className={`text-sm  ${isDark ? 'bg-gradient-to-r from-yellow-900 via-yellow-800 to-yellow-600  text-transparent bg-clip-text' : 'text-stone-300'}`}>Coffee and Workspace</div>
    </div>
  </div>
);
