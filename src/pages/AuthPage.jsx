...
const AuthPage = () => {
  ...
  }, [isLogin, email, password, rePassword, userName, phoneNumber, emailError, passwordError]);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (isLogin) {
      if (email && password) { // Kiểm tra email và password có giá trị
        await loginUser();
      } else {
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="relative mb-6">
                    ...
                    <label
                      ...
                      className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out ${
                        userName ? "-translate-y-[1.15rem] scale-[0.8] text-primary" : ""
                ...
                <div className="relative mb-6">
                  ...
                  <label
                    htmlFor="emailInput"
                    className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out ${
                      email ? "-translate-y-[1.15rem] scale-[0.8] text-primary" : ""
                    } peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[1.15rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary`}
                  >
                    Email Address
                  </label>
                ...
                <div className="relative mb-6">
                  ...
                  <label
                    ...
                    className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out ${
                      password ? "-translate-y-[1.15rem] scale-[0.8] text-primary" : ""
                    } peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[1.15rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary`}
                  >
                    Password
                  </label>
                  ...
                  <>
                    ...
                    <div className="relative mb-6">
                      ...
                      <label
                        ...
                        className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out ${
                          rePassword ? "-translate-y-[1.15rem] scale-[0.8] text-primary" : ""
                        } peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[1.15rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary`}
                      >
                        Re-enter Password
                      </label>
                    ...
                    <div className="relative mb-6">
                      ...
                      <label
                        ...
                        className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[2.15] text-neutral-500 transition-all duration-200 ease-out ${
                          phoneNumber ? "-translate-y-[1.15rem] scale-[0.8] text-primary" : ""
                        } peer-focus:-translate-y-[1.15rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[1.15rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary`}
                      >
                        Phone Number
                      </label>
