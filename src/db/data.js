...
export const roomData = [
  {
    ...
    facilities: [
      ...
      { name: 'Lighting', icon: FaCoffee },
      { name: 'Ergonomic chair ', icon: FaBath },
      { name: 'Modern desk', icon: FaParking },
      { name: 'Power outlets', icon: FaSwimmingPool },
      { name: 'BAir conditioning', icon: FaHotdog },
      { name: 'Plants', icon: FaStopwatch },
      { name: 'Drinking water', icon: FaCocktail },
    ],
    size: 30,
    maxPerson: 1,
    price: 115,
  ...
  },
  {
    ...
    facilities: [
      { name: 'Wifi', icon: FaWifi },
      { name: 'Modern desk', icon: FaCoffee },
      { name: 'Ergonomic chair', icon: FaBath },
      { name: 'Power outlets', icon: FaParking },
      { name: 'Air conditioning', icon: FaSwimmingPool },
      { name: 'Plants', icon: FaHotdog },
      { name: 'Large screen', icon: FaStopwatch },
      { name: 'Sound system', icon: FaCocktail },
    ],
    size: 70,
    maxPerson: 2,
    price: 220,
